...
import { Recherche } from "../ajoutproduit/categorie";
  ...
  useEffect(() => {
    const fetchInitialData = async () => {
      try {
        ...
        const storedId = JSON.parse(sessionStorage.getItem("id_produit_modifier"));
        ...
        if (categoriesResponse?.data?.data) {
          const categories = categoriesResponse.data.data.map((item) => item.label);
